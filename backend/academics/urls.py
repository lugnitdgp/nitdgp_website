...
urlpatterns = [
    ...
    url(r'^academics/newadmission/$', NewAdmissionViewSet.as_view(), name='view-newadmission'),
    ...
    url(r'^academics/curriculum/$', CurriculumViewSet.as_view(), name='view-curriculum'),
