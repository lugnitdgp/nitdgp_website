  ...
  <nav class="navbar navbar-expand-lg navbar-dark darken-2" id="nav-below">
    <div class="container-fluid" >
      <div class="navbar-header">
        <img class="navbar-brand" src="http://172.16.20.3/nitdgp_website/static/img/nitdgp_logo_white.png">
        <img class="line-img" src="http://172.16.20.3/nitdgp_website/static/img/line.png">
        <img class="navbar-img-small" src="http://172.16.20.3/nitdgp_website/static/img/emblem.png">
        <div class="navbar-text white-text ">
          <div align="left">
            ...
            <p class="navbar-text-small">(An Institute of National Importance under Government of India,<br> Ministry of Human Resource Development)</p>
          </div>
        </div>
        <img class="navbar-img-big"  src="http://172.16.20.3/nitdgp_website/static/img/emblem.png">
