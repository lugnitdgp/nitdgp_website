        ...
        <h2>Goals/Objectives</h2>
          <p style="padding: 10px;">
            ...
            <ol>
              ...
              <li>To conduct training programmes in the related areas for professional skill development.</li>
              <li>To Generate Intellectual Properties (IP) in terms of patents and high quality technical publications.</li>
              <li>To established regional green building monitoring centre.</li>
              <li>To established Suryamitra Skill Development Programme under National Skill Development Corporation (NSDC).
              Technology transfer</li>
              <li>To facilitate incubation of business ideas from students and mentor them to develop as entrepreneurs in relevant areas.</li>
              <li>To introduce post graduate courses in energy with certain specializations that will focus on emerging areas of energy devices Design and Development, sensors, smart materials, etc.</li>
              <li>To provide a platform for interaction between industry fraternity with scientists and management experts from neighbouring institutions interested to work in identified topics by organizing regular seminar series.</li>
              <li>To conduct courses with significant participation from external faculty, industrial and regulatory experts in the field of energy.
              Offer PhD courses in relevant areas of expertise. Also to provide customized/flexible PhD Courses to student(s) of any department of the institute pursuing/ intended to pursue his/her thesis on specific problems in energy.</li>
              <li>To integrate the various aspects related to energy in the institute under one roof to better utilize the resources of the Institution.</li>
        ...
        <h2>Partners and Stakeholders</h2>
          <p style="padding: 10px;">
            ...
            <ul>
              ...
              <li>National Institute of Solar Energy (NISE), Gurgaon, Haryana </li>
              <li>Durgapur steel plant, Durgapur</li>
              <li>The Energy and Resources Institute, Delhi</li>
            </ul>
            <h3>Stakeholders</h3>
            <ul>
        ...
        <h2>Benefits</h2>
          <p style="padding: 10px;">
            ...
            <ul>
              ...
              <li>interact with faculty and students across different disciplines; </li>
              <li>learn techniques that address Energy and health science research questions;
                <ul>
                  <li>experience the synergy of an interdisciplinary approach to understanding energy systems; </li>
                </ul>
              </li>
              <li>develop an appreciation for interrelationships among the disciplines; </li>
            </ul>
            <h3>Faculty members will:</h3>
            <ul>
          ...
          <div class="card-text">
            <div style="border: 2px solid #cad;margin-bottom: 5px;text-align: justify;" class="descbox">
              <p style="padding: 10px;">
                ...
                <h3>Energy: </h3>
                  <ul>
                    <li>Solar/bio and Hybrid Energy Generation, Integration and Control </li>
                    <li>Development of near transparent In2O3-SiO2heterostructure nanowires (NWs) based broadband antireflection coatings for the front panel to increase the efficiency of existing solar cells</li>
                    <li>Genetic Engineering of Microalgae for Development of Bio-Diesel</li>
                    <li>Emerging power devices for sustainable energy application</li>
                    <li>Green building system</li>
                    <li>Integrated Bio-fuel production unit and its performance test under various percentage of bio-diesel</li>
                    <li>National Skill Development under Suryamitra training programme</li>
                  </ul>
              </p>
            </div>
          </div>
            ...
            <div style="border: 2px solid #cad;margin-bottom: 5px;text-align: justify;" class="descbox">
              <p style="padding: 10px;">
                <h3>Academic Committee Members: </h3>
                  <ol>
                      <li>Prof. P. Acharjee, EE, </li>
                      <li>Prof. S. N. Mahato, EE</li>
                      <li>Prof. A. K. Banik, CE</li>
                      <li>Prof. K. Aikat, BT</li>
                      <li>Prof. T. K. Saha, EE</li>
                      <li>Dr. A. Mandal, Physics</li>
              ...
              <div style="border: 2px solid #cad;margin-bottom: 5px;text-align: justify;" class="descbox">
                <p style="padding: 10px;">
                  ...
                  <ol>
                      <li>Dr. Sudit Mukhopadhaya, BT </li>
                      <li>Dr. R. N. Barman, ME</li>
                      <li>Dr. Rajat Mahapatra, ECE</li>
                      <li>Dr. A. K. Banik, CE</li>
                      <li>Dr. Sujit Karmakar, ME</li>
                      <li>Dr. Apurba Layek, ME</li>
                      <li>Dr. N. K. Roy, EE</li>
                      <li>Dr. Ashish Bhattacharjee, BT</li>
                      <li>Dr. Apurba Dey, BT</li>
                      <li>Dr. Sufia Kazy, BT</li>
                      <li>Dr. J. Chakraborty, CY</li>
                      <li>Dr. S. Roy Barman, BT</li>
                      <li>Dr. Jayati Dey, EE</li>
                      <li>Dr. Diptesh Das, CE</li>
                      <li>Dr. Gopinath Halder, CH</li>
                      <li>Dr. Mousami Roy,MS</li>
