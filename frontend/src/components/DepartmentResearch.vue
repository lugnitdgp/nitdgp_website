    ...
    <sp-card v-if="dept" containerclass="l2-card" bodyclass="text-center">
      ...
      <div class="tabs-wrapper up-content mx-auto">
        <ul class="nav classic-tabs" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link waves-light active" :class="{'disabled': !dept.research.length }" :href="'/department/'+this.$route.params.short_code+'/research'" role="tab" >Research</a>
          </li>
          <li class="nav-item">
      ...
      <div class="tab-content card down-content">
        <div class="tab-pane fade show active big-list" id="li5" role="tabpanel" aria-labelledby="li5-list">
